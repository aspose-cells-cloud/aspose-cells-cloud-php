...
**back_wall** | [**\Aspose\Cells\Cloud\Model\LinkElement**](LinkElement.md) |  | [optional] 
**category_axis** | [**\Aspose\Cells\Cloud\Model\LinkElement**](LinkElement.md) | Gets the chart&#39;s X axis. The property is read only | [optional] 
**chart_area** | [**\Aspose\Cells\Cloud\Model\LinkElement**](LinkElement.md) | Gets the chart area in the worksheet | [optional] 
**chart_data_table** | [**\Aspose\Cells\Cloud\Model\LinkElement**](LinkElement.md) | Represents the chart data table. | [optional] 
**chart_object** | [**\Aspose\Cells\Cloud\Model\LinkElement**](LinkElement.md) | Represents the chartShape; | [optional] 
...
**floor** | [**\Aspose\Cells\Cloud\Model\LinkElement**](LinkElement.md) | Returns a Floor object that represents the walls of a 3-D chart. | [optional] 
...
**legend** | [**\Aspose\Cells\Cloud\Model\LinkElement**](LinkElement.md) | Gets the chart legend. | [optional] 
**name** | **string** | Gets and sets the name of the chart. | [optional] 
**n_series** | [**\Aspose\Cells\Cloud\Model\LinkElement**](LinkElement.md) | Gets a SeriesCollection collection representing the data series in the chart. | [optional] 
**page_setup** | [**\Aspose\Cells\Cloud\Model\LinkElement**](LinkElement.md) | Represents the page setup description in this chart. | [optional] 
...
**plot_area** | [**\Aspose\Cells\Cloud\Model\LinkElement**](LinkElement.md) | Gets the chart&#39;s plot area which includes axis tick lables. | [optional] 
...
**second_category_axis** | [**\Aspose\Cells\Cloud\Model\LinkElement**](LinkElement.md) | Gets the chart&#39;s second X axis. | [optional] 
**second_value_axis** | [**\Aspose\Cells\Cloud\Model\LinkElement**](LinkElement.md) | Gets the chart&#39;s second Y axis. | [optional] 
