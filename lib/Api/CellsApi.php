...
class CellsApi
{
     ...
     */
    public function cellsGetCellHtmlStringWithHttpInfo($name, $sheet_name, $cell_name, $folder = null, $storage = null)
    {
        $returnType = 'object';
        $request = $this->cellsGetCellHtmlStringRequest($name, $sheet_name, $cell_name, $folder, $storage);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cellsGetCellHtmlStringAsync($name, $sheet_name, $cell_name, $folder = null, $storage = null)
    {
        return $this->cellsGetCellHtmlStringAsyncWithHttpInfo($name, $sheet_name, $cell_name, $folder, $storage)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cellsGetCellHtmlStringAsyncWithHttpInfo($name, $sheet_name, $cell_name, $folder = null, $storage = null)
    {
        $returnType = 'object';
        $request = $this->cellsGetCellHtmlStringRequest($name, $sheet_name, $cell_name, $folder, $storage);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function cellsGetCellHtmlStringRequest($name, $sheet_name, $cell_name, $folder = null, $storage = null)
    {
        // verify the required parameter 'name' is set
        if ($name === null) {
            throw new \InvalidArgumentException(
