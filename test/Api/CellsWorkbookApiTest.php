...
use \Aspose\Cells\Cloud\Api\CellsWorkbookApi;
...
class CellsWorkbookApiTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->instance = new  CellsWorkbookApi();
    ...
    public function testCellsWorkbookPostWorkbookCalculateFormula()
    {
        ...
        $ignoreError = 'true';
        CellsApiTestBase::ready( $name ,$folder);
        $result = $this->instance->cellsWorkbookPostWorkbookCalculateFormula($name, $options,  $folder);
        $this->assertEquals(200, $result['code']);
    }
    ...
    public function testCellsWorkbookPutConvertWorkBook()
    {
        ...
        $this->assertEquals(6730, $result->getSize());
    }
    ...
    public function testCellsWorkbookPutWorkbookCreate()
    {
        ...
        CellsApiTestBase::ready( $templateFile ,$folder);
        CellsApiTestBase::ready( $dataFile ,$folder);
